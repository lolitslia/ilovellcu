...
function blankslate_enqueue()
{
  ...
  wp_enqueue_style('ilovellc-style', get_template_directory_uri() . '/ilovellc.css');
  // wp_enqueue_script('jquery');
  //wp_enqueue_script('ilovellc-scripts', get_template_directory_uri() . '/assets/js/scripts.js');
}
...
function iluvllc_scripts()
{
  wp_register_script('llcscripts-js', get_template_directory_uri() . '/assets/js/scripts.js', array(), null, true);
  wp_enqueue_script('llcscripts-js');
}
add_action('wp_enqueue_scripts', 'iluvllc_scripts');
